...
export function handler(event, context, callback) {
  ...
  const API_STORE_HASH = process.env.GATSBY_API_STORE_HASH
  const API_CLIENT_ID = process.env.GATSBY_API_CLIENT_ID
  const API_TOKEN = process.env.GATSBY_API_TOKEN
  const API_SECRET = process.env.GATSBY_API_SECRET
  const CORS_ORIGIN = process.env.GATSBY_CORS_ORIGIN
  // Set up headers
